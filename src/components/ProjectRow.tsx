...
export function ProjectRow({ work }: ProjectRowProps) {
  return (
    <article className="grid items-start gap-8 border-t border-border/40 py-12 md:grid-cols-2 md:gap-14 md:py-16">
      {/* Screenshot */}
      <AnimatedContent direction="horizontal" reverse={true} distance={50}>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-1 text-sm font-medium">
            {work.liveUrl && (
              <a
                ...
                className="flex min-h-[44px] items-center gap-1 transition-colors hover:text-primary"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                View Project ↗
              </a>
            ...
            {work.repoUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex min-h-[44px] items-center gap-1 text-muted-foreground transition-colors hover:text-foreground"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                View Repository ↗
              </a>
