...
export default function Home() {
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto w-full max-w-4xl px-6 py-20 md:px-12">
        <div className="flex flex-col gap-6">
          ...
          <SplitText
            text="Gilead Odo"
            tag="h1"
            className="text-5xl leading-tight font-normal tracking-tight md:text-8xl lg:text-9xl"
            textAlign="left"
            splitType="chars"
            delay={40}
            duration={1}
          ...
          <AnimatedContent distance={30} duration={0.7} delay={0.6}>
            <div className="flex flex-wrap items-center gap-4">
              <Magnet padding={60} magnetStrength={3}>
                <Link href="/contact">
                  <Button size="lg" className="group gap-2 font-medium">
                    Get in touch
